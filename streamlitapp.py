...
with st.sidebar:
    ...
    st.title('Lip Sync Bro')
    st.info('This application is originally developed from the LipNet Research paper.')
...
if options: 
    ...
    with col2: 
        ...
        imageio.mimsave('animation.gif',np.squeeze((video_np * 25).astype(np.uint8)) , duration=100)
